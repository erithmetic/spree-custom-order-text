...
desc 'Generate documentation for the custom_order_text extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'CustomOrderTextExtension'
...
desc 'Test the custom_order_text extension.'
...
namespace :test do
  desc 'Functional test the custom_order_text extension.'
  ...
  desc 'Unit test the custom_order_text extension.'
